package com.fxyublib.android.library.weekview;
...
//            }
        ...
        if(Build.VERSION.SDK_INT >= 26){
            ...
            //canvas.clipRect(0, 0, getWidth(), mHeaderTextHeight + mHeaderRowPadding * 2);
        }else {
            //canvas.clipRect(mHeaderColumnWidth, 0, getWidth(), mHeaderTextHeight + mHeaderRowPadding * 2, Region.Op.REPLACE);
        }
        ...
        if (mDateTimeInterpreter == null) {
            mDateTimeInterpreter = new DateTimeInterpreter() {
                ...
                public String interpretDate(Calendar date) {
                    try {//EEEEE  EEEE
                        SimpleDateFormat sdf = mDayNameLength == LENGTH_SHORT ? new SimpleDateFormat("EEEEE M/dd", Locale.CHINA)
                                : new SimpleDateFormat("E M/dd", Locale.CHINA);
                ...
                public String interpretTime(int hour) {
                    ...
                    try {
                        SimpleDateFormat sdf = DateFormat.is24HourFormat(getContext()) ? new SimpleDateFormat("HH:mm", Locale.CHINA)
                                : new SimpleDateFormat("hh a", Locale.CHINA);
